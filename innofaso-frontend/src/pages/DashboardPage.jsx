...
import IotWidget from "../components/IotWidget.jsx";
      ...
      <div className="dashboard-grid">
        ...
        <div className="dash-main">
          ...
          <div className="dash-side">
            <IotWidget zonePath="zones/zone1" zoneLabel="Zone Production" />
            ...
            {selectedMapZone ? (
              ...
              /* Pas de zone sélectionnée → message invitant à sélectionner une zone */
              <div style={{
                display: "flex", flexDirection: "column", alignItems: "center",
                justifyContent: "center", height: "100%", minHeight: 200,
                color: "var(--txt3)", fontSize: 13, gap: 8, textAlign: "center",
                padding: "24px 16px",
              }}>
                ...
                <span>Cliquez sur une zone de la carte pour voir le détail et l'historique</span>
                <span style={{ fontSize: 11, opacity: 0.6 }}>L'historique complet est disponible dans la page Historique</span>
              </div>
            )}
          </div>
        </div>
